...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-plnmodels-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-plnmodels-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-plnmodels
# for installing globally
pixi global install r-plnmodels
```
...
It is possible to list all of the versions of `r-plnmodels` available on your platform:
...
```
pixi search r-plnmodels --channel conda-forge
```
